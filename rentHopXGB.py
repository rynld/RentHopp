...
param = {'max_depth':6, 'eta':0.1, 'silent':1, 'objective':'multi:softprob' ,'num_class':3,'eval_metric':'mlogloss','subsample':0.7,\
...
model = xgb.train(params=param,dtrain= xgTrain, num_boost_round= 300)
