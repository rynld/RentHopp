...
mapdata = np.loadtxt("sf/sf_map_copyright_openstreetmap_contributors.txt")
...
train = pd.read_csv('sf/train.csv')
...
train = train[1:3000] #Can't use all the data and complete within 600 sec :(
